            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-trader-gray rounded-xl p-8 mb-12">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  together with a shared vision: to democratize access to
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  take for granted. The high cost of premium financial analysis
                ...
                <p className="text-gray-700">
                  ...
                  advancements in artificial intelligence to deliver
                  research-backed trading insights at a fraction of the
                  traditional cost.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white shadow-soft rounded-xl p-8">
                  ...
                  <p className="text-gray-700">
                    ...
                    accuracy than traditional analysis.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-trader-blue/5 rounded-xl p-8">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  published in Finance Research Letters - the top-ranked
                  journal in Business Finance - have shown that AI models like
