...
const applyBillingToUserId = async (
  ...
  if (extras) {
    const keys: (keyof SubscriptionBillingExtras)[] = [
      ...
      "stripe_pending_recurring_unit_amount",
      "stripe_pending_recurring_currency",
...
const inactiveSubscriptionExtras = (
  ...
  return {
    ...
    stripe_pending_recurring_interval: null,
    stripe_pending_recurring_unit_amount: null,
    stripe_pending_recurring_currency: null,
