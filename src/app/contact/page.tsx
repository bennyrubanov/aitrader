        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-8">Help &amp; Contact</h1>
              ...
              <div className="bg-muted/40 rounded-xl p-8 mb-12 text-left border border-border">
                ...
                <div className="flex items-center justify-center p-6 bg-card rounded-lg border border-border shadow-soft mb-6">
                  <Mail className="w-6 h-6 text-trader-blue mr-3" />
                  <a
                    href="mailto:tryaitrader@gmail.com"
                    className="text-lg font-medium text-trader-blue hover:underline"
                  >
                  ...
                  <ul className="space-y-4">
                    <li>
                      ...
                      <p className="text-muted-foreground text-sm mt-1">
                        ...
                        research-backed stock ratings and portfolio recommendations.
                      </p>
                    </li>
                    <li>
                ...
                <div className="bg-card border border-border shadow-soft rounded-xl p-8">
                  ...
                  <ul className="space-y-4">
                    <li>
                      ...
                      <p className="text-muted-foreground text-sm mt-1">
                        Read our latest insights on AI-powered investing.
                      </p>
                    </li>
                    <li>
                      <Link
