            ...
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Thank you for subscribing! You now have access to our premium
                  features.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-elevated border border-gray-100 p-8 mb-12">
                ...
                <div className="mb-8">
                  <p className="text-gray-600 mb-4">
                    Our AI Trader bot is a bespoke, custom-trained AI model that
                    uses science-backed methodology to provide you with
                    personalized trading insights and recommendations.
                  </p>

                  <p className="text-gray-600 mb-4">
                    Unlike generic trading algorithms, our model is specifically
                    designed to identify patterns in market data using advanced
                    machine learning techniques that have been validated through
                    rigorous scientific testing.
                  </p>

                  <p className="text-gray-600 mb-4">
                    Simply ask the AI Trader bot about any stock, market trend,
                    or trading strategy, and receive expert analysis backed by
