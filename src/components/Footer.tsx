        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/tryaitrader/reels/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/70 hover:text-trader-blue transition-colors">
              ...
              {/* Facebook */}
              <a href="#" className="text-muted-foreground/70 hover:text-trader-blue transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              {/* Twitter */}
              {/* <a href="#" className="text-muted-foreground hover:text-trader-blue transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/help" className="text-muted-foreground hover:text-trader-blue transition-colors">Help Center</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6">
              ...
              <li><Link href="/help" className="text-muted-foreground hover:text-trader-blue text-sm transition-colors">Contact</Link></li>
            </ul>
          </div>
        </div>
      </div>
