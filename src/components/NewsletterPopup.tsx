  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await asyncErrorHandler(
      async () => {
        ...
        // If the email already exists, treat it as already subscribed.
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Subscribe to AI Trader Newsletter</DialogTitle>
          <DialogDescription className="text-base mt-2">
            Get weekly reports and updates on the latest trendy stocks suggested by AI Trader. It's
            completely free!
          </DialogDescription>
        </DialogHeader>
        ...
        {!isSubmitted ? (
          ...
          <div className="py-6 text-center">
            ...
            <h3 className="text-lg font-medium text-foreground">
              {wasAlreadySubscribed ? "You're already subscribed" : 'Thanks for subscribing!'}
            </h3>
            <p className="text-muted-foreground mt-1">
              {wasAlreadySubscribed
                ? "This email is already on our list. You'll keep receiving weekly stock trend updates."
