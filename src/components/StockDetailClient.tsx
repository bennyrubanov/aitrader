...
import { getRecommendationHistory, ratingScore } from "@/lib/stockRecommendations";
...
const StockDetailClient = ({ symbol }: StockDetailClientProps) => {
  ...
  const history = useMemo(
    () => getRecommendationHistory(normalizedSymbol),
    [normalizedSymbol]
  );
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <h1 className="text-3xl md:text-5xl font-bold">
                    {normalizedSymbol} {stock?.name ? `· ${stock.name}` : ""}
                  </h1>
                </div>
                <Link href="/platform">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    {latest?.summary ?? "Recommendation summary unavailable."}
                  </p>
              ...
              <div className="mt-10 text-sm text-gray-500">
                This page is structured for SEO-ready static pages. Once Supabase
                data is connected, replace the placeholder history with real daily
                recommendations and performance overlays.
              </div>
            </div>
          </div>
        </section>
