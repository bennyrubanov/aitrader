...
from daily;
-- Reset existing objects (safe when no data exists)
drop view if exists public.nasdaq100_scores_7d_view;
drop view if exists public.nasdaq100_current_members;
drop view if exists public.nasdaq100_latest_snapshot;
drop table if exists public.nasdaq100_recommendations_current cascade;
drop table if exists public.ai_analysis_runs cascade;
drop table if exists public.ai_run_batches cascade;
drop table if exists public.nasdaq_100_daily_raw cascade;
...
drop table if exists public.ai_models cascade;
drop table if exists public.ai_prompts cascade;
drop table if exists public.stock_daily_ratings cascade;
drop table if exists public.stock_score_rollups cascade;
drop table if exists public.weekly_portfolios cascade;
drop table if exists public.universe_runs cascade;
drop table if exists public.universe_run_stocks cascade;
drop table if exists public.prompts cascade;
drop table if exists public.nasdaq100_stocks cascade;
drop table if exists public.stock_recommendations cascade;
drop table if exists public.daily_universes cascade;
drop table if exists public.daily_universe_stocks cascade;
...
-- =========================
-- 3) NASDAQ-100 membership snapshots
-- =========================
...
-- =========================
-- 4) Daily NASDAQ API snapshot (optional but useful)
-- =========================
...
-- =========================
-- 6) One run = one stock + one output
-- =========================
...
-- =========================
-- 7) Current daily recommendations (NASDAQ-100 only)
-- =========================
...
-- =========================
-- 8) Rolling 7-day average view (computed)
-- =========================
...
create index if not exists idx_ai_prompts_name_version on public.ai_prompts(name, version);
-- Optional reset (safe when no data exists)
drop view if exists public.nasdaq100_scores_7d_view;
drop view if exists public.nasdaq100_current_members;
drop view if exists public.nasdaq100_latest_snapshot;
...
create index if not exists idx_ai_prompts_name_version on public.ai_prompts(name, version);
create index if not exists idx_ai_models_provider_name_version on public.ai_models(provider, name, version);

-- =========================
-- 2) Canonical stocks table (shared across indices later)
-- =========================
...
-- =========================
-- 4) Daily raw NASDAQ API snapshot (optional)
-- =========================
...
-- =========================
-- 8) Weekly rolling average view (computed)
-- =========================
